...
If you are ready, simply click _Ctrl+Alt+T_ to open the terminal
...
#### If your version of _Python_ is 3 or higher you can install **pip** module
...
Now you can use pip to install _Python_ modules, but first clone BIT_AI github repository
...
#### Great! Now you are ready to install necessary _Python_ modules
...
Check if everything is correct, try to import: _numpy_, _tensorflow_, _matplotlib_, _sklearn_
...
**Hint** Type _Ctrl+c_ to stop jupyter server :)
...
to enter notebook go to browser and type [http://localhost:$](http://localhost:$)
